...
def _random_crop(image_list, crop_height, crop_width):
  ...
  # offset_height = tf.compat.v1.random_uniform_initializer(
  #     [], maxval=max_offset_height, dtype=tf.int32)
  # offset_width = tf.compat.v1.random_uniform(
  #     [], maxval=max_offset_width, dtype=tf.int32)
  offset_height = tf.random.uniform([],maxval= max_offset_height,
                                    dtype=tf.dtypes.int32)
  offset_width = tf.random.uniform([],maxval=max_offset_width,
                                   dtype=tf.dtypes.int32)
