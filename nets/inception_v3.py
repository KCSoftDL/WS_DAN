...
trunc_normal = lambda stddev: tf_v1.truncated_normal_initializer(0.0, stddev)
...
def inception_v3_base(inputs,
    ...
    with tf_v1.variable_scope(scope, 'InceptionV3', [inputs]):
...
def inception_v3_head(net,end_points,
    ...
    with tf_v1.variable_scope(scope, 'InceptionV3', [net], reuse=tf_v1.AUTO_REUSE):
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                            stride=1, padding='SAME'):
            # mixed_8: 8 x 8 x 1280.
            end_point = 'Mixed_7a'
...
def inception_v3(inputs,
    ...
    with tf_v1.variable_scope(scope, 'InceptionV3', [inputs], reuse=reuse) as scope:
        with slim.arg_scope([slim.batch_norm, slim.dropout],
            ...
            with tf_v1.variable_scope('bilinear_attention_pooling'):
                ...
                attention_image = tf_v1.py_func(generate_attention_image, [inputs[0], attention_maps[0]], tf.uint8)
